...
const HomeScreen = () => {
  ...
  const menuItems: { title: string; icon: "list-alt" | "coffee" | "file-text-o" | "cutlery" | "book" | "bar-chart"; screen: string; onPress: () => void }[] = [
    { title: 'Tạo Order', icon: 'list-alt', screen: 'CreateOrderScreen', onPress: () => router.push('./CreateOrderScreen') },
    { title: 'Quản lý nguyên liệu', icon: 'coffee', screen: 'InventoryScreen', onPress: () => router.push('./InventoryScreen') },
    ...
    { title: 'Quản lý sách', icon: 'book', screen: 'BookScreen', onPress: () => router.push('./BookScreen') },
